...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/168808/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://aldh.cc',

  // 网站标题
  title: '阿拉导航 - 精选实用导航网站',

  // 网站描述
  description: '阿拉导航 - 精选实用导航网站',

  // 网站关键字
  keywords: '导航,资源,社区站点,实用工具,学习资源,运营',
  ...
  footerContent: `
    ...
    <div>Copyright © 2021-2061 aldh.cc, All Rights Reserved</div>
  `,

  // 百度统计地址
  // https://tongji.baidu.com/web/welcome/login
  baiduStatisticsUrl: 'https://hm.baidu.com/hm.js?e1be6a654aa48c5e48ad64a6f94f6e78',
  ...
  // Light 主题配置
  lightThemeConfig: {
    // https://aldh.cc/#/light?q=grabient
    backgroundLinear: [
